            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex justify-center">
                    ...
                    <img 
                        ...
                        className="rounded-lg shadow-xl border border-slate-700 max-h-80 object-cover w-full" alt="A smiling man with glasses works on a laptop in a bright, modern office."/>
                </div>
            </div>
        </div>
    );
